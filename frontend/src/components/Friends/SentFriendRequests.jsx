...
const SentFriendRequests = ({
  ...
  const requests = Array.isArray(sentFriendRequests) ? sentFriendRequests : [];
  ...
  return (
    ...
    >
      <Flex justify="space-between" align="center" mb={3}>
        <Flex align="center">
          <EmailIcon mr={2} />
          <Heading size="md" mr={2} color="teal.500">
        ...
        <IconButton
          ...
          aria-label={
            isOpen
              ? "Collapse Sent Friend Requests"
              : "Expand Sent Friend Requests"
          }
          variant="outline"
          size="sm"
        />
      ...
      <Collapse in={isOpen} animateOpacity>
        {requests.length > 0 ? (
          ...
          <Text>No sent friend requests found.</Text>
        )}
      </Collapse>
    </Box>
  );
